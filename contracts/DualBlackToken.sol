...
contract DualBlack is Context, IERC20, Ownable {
    ...
    address private _middleman = address(0);
    
    Middleman MM = Middleman(_middleman);
    
    address private _pair = address(0);

    string private _name = 'Dual - BLACK';
    string private _symbol = '$DBLACK';
