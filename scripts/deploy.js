...
async function main() {
    ...
    console.log("Linking Dividend to Contender");
    redDividendTrackerContract.setContender(redAddress);
    blueDividendTrackerContract.setContender(blueAddress);

    console.log("Linking Contender to Dividend");
    redContract.setDividendTracker(redDividendTrackerAddress);
    blueContract.setDividendTracker(blueDividendTrackerAddress);
